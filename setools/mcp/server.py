...
class SEToolsMCPServer:
    ...
    #
    @staticmethod
    def _collect_results(query: PolicyQuery, key: str, *, max_results: int = 32768) -> str:
        """
        Collect results from *query* up to *max_results* and return a JSON string.

        The returned object always has 'count', 'truncated', and *key* fields.
        """
    ...
    def setools_get_policy_info(
        ...
        return json.dumps(self._load_policy(policy_path), cls=MCPEncoder, indent=2)
    ...
    def setools_search_te_rules(
        ...
        return self._collect_results(q, "rules", max_results=max_results)
    ...
    def setools_list_types(
        ...
        return self._collect_results(q, "types", max_results=max_results)
    ...
    def setools_list_type_attributes(
        ...
        return self._collect_results(q, "attributes", max_results=max_results)
    ...
    def setools_list_roles(
        ...
        return self._collect_results(q, "roles", max_results=max_results)
    ...
    def setools_list_users(
        ...
        return self._collect_results(q, "users", max_results=max_results)
    ...
    def setools_list_classes(
        ...
        return self._collect_results(q, "classes", max_results=max_results)
    ...
    def setools_list_commons(
        ...
        return self._collect_results(q, "commons", max_results=max_results)
    ...
    def setools_list_booleans(
        ...
        return self._collect_results(q, "booleans", max_results=max_results)
    ...
    def setools_list_sensitivities(
        ...
        return self._collect_results(q, "sensitivities", max_results=max_results)
    ...
    def setools_list_categories(
        ...
        return self._collect_results(q, "categories", max_results=max_results)
    ...
    def setools_list_polcaps(
        ...
        return self._collect_results(q, "polcaps", max_results=max_results)
    ...
    def setools_list_permissive_types(
        ...
        return self._collect_results(q, "permissive_types", max_results=max_results)
    ...
    def setools_list_typebounds(
        ...
        return self._collect_results(q, "typebounds", max_results=max_results)
    ...
    def setools_list_constraints(
        ...
        return self._collect_results(q, "constraints", max_results=max_results)
    ...
    def setools_list_defaults(
        ...
        return self._collect_results(q, "defaults", max_results=max_results)
    ...
    def setools_list_fs_uses(
        ...
        return self._collect_results(q, "fs_uses", max_results=max_results)
    ...
    def setools_list_genfscons(
        ...
        return self._collect_results(q, "genfscons", max_results=max_results)
    ...
    def setools_list_initialsids(
        ...
        return self._collect_results(q, "initialsids", max_results=max_results)
    ...
    def setools_list_portcons(
        ...
        return self._collect_results(q, "portcons", max_results=max_results)
    ...
    def setools_list_netifcons(
        ...
        return self._collect_results(q, "netifcons", max_results=max_results)
    ...
    def setools_list_nodecons(
        ...
        return self._collect_results(q, "nodecons", max_results=max_results)
    ...
    def setools_list_ibpkeycons(
        ...
        return self._collect_results(q, "ibpkeycons", max_results=max_results)
    ...
    def setools_list_ibendportcons(
        ...
        return self._collect_results(q, "ibendportcons", max_results=max_results)
    ...
    def setools_list_iomemcons(
        ...
        return self._collect_results(q, "iomemcons", max_results=max_results)
    ...
    def setools_list_ioportcons(
        ...
        return self._collect_results(q, "ioportcons", max_results=max_results)
    ...
    def setools_list_pcidevicecons(
        ...
        return self._collect_results(q, "pcidevicecons", max_results=max_results)
    ...
    def setools_list_pirqcons(
        ...
        return self._collect_results(q, "pirqcons", max_results=max_results)
    ...
    def setools_list_devicetreecons(
        ...
        return self._collect_results(q, "devicetreecons", max_results=max_results)
