...
class TestLookupFileContext:
    def test_lookup_default_filetype(self, mcp_server: SEToolsMCPServer) -> None:
        ...
        assert data["count"] == 1
        assert data["result"] == "user0:role0:type7:s0:c0"
